...
// var ruby_dic = [["天王洲","てんのうず"],["蝙蝠","こうもり"],["逢螺","あいら"],["数多","あまた"],["明星","みょうじょう"],["跋扈","ばっこ"],["餌食","えじき"],["徘徊","はいかい"],["恐慌","きょうこう"],["方舟","はこぶね"],["蹂躙","じゅうりん"],["未曾有","みぞう"],["弄ば","もてあそ"],["莫大","ばくだい"],["卑劣","ひれつ"],["挫け","くじ"],["遮","さえぎ"],["媒介","ばいかい"],["依代","よりしろ"],["顕現","けんげん"],["司り","つかさど"],["眷属","けんぞく"],["甲斐甲斐","かいがい"],["罹り","かか"],["乃蒼","のあ"],["伝染る","うつ"],["傘下","さんか"],["闇黒","あんこく"],["緑眼","りょくがん"],["一霞","いちか"],["星辰","せいしん"],["刻の","とき"],["蔓延","まんえん"]];
var ruby_dic = [["乃苍", "Noa"], ["一霞", "Ichika"], ["纺希", "Tsumugi"], ["国木", "Kunugi"], ["倪克斯", "Nyx"], ["赫墨拉", "Hemera"], ["厄瑞玻斯", "Erebus"], ["韩赛尔与格蕾特", "Hänsel und Gretel"], ["艾薇", "Ivy"], ["有栖", "Arisu"], ["涅普顿", "Neptunus"], ["海王星", "Neptune"]];
    return ruby_dic;
};
